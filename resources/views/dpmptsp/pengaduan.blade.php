                            ...
                            <form id="add-form">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-12 mb-lg-2">
                                        ...
                                        <span style="color:red;">Note: </span><span>Harap pastikan E-mail anda aktif! Karena Jawaban akan diberikan Melalui E-mail!</span>
                                        <button type="submit" class="btn btn-danger mt-4" style="width: 100%; color:white;">Kirim Pengaduan</button>
                                    </div>
                                </div> 
                            </form>       
                        </div>
                        ...
                        <div class="d-flek"> 
                            ...
                            <div class="row" style="position: relative; bottom: 0px;margin-bottom: 0px;">
                                <div class="text-center">
                                    <a href="/detail_pengaduan" class="btn bg-red" style="width: 30%; color:white;">Lihat Lainnya</a>
                                </div>
                            </div>
                        </div>            
                    </div>
